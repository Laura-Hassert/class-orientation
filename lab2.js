...
//////////////////////////// PROBLEM 8 ////////////////////////////
/*
  Create a class called 'Cat'. Make sure to call your constructor, and require these 3 parameters: name, 
  age, color.
...
let cat1 = new Cat('Snowball', 6, 'white');
...
class Wizard {
    ...
    castSpell(spellTime) {
        ...
        this.favoriteSpell = spellTime;
    }
}

const wizard1 = new Wizard('Hermione', 20, 'leviosa');

wizard1.castSpell('sleep');
console.log(wizard1);
